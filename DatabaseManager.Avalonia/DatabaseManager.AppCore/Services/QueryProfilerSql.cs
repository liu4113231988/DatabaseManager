...
public static class QueryProfilerSql
{
    public static bool SupportsAnalyze(DatabaseType databaseType)
        => databaseType is DatabaseType.MySql or DatabaseType.Postgres or DatabaseType.KingbaseES or DatabaseType.SqlServer or DatabaseType.Oracle;
    ...
    {
        DatabaseType.MySql or DatabaseType.Postgres or DatabaseType.KingbaseES => $"EXPLAIN ANALYZE {statement}",
